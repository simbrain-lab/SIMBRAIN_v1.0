...
for test_cnt in range(multiple_test_no):
    ...
    for epoch in range(n_epochs):
        ...
        for step, batch in enumerate(dataloader):
            ...
            if (step >= 500 or epoch > 0) and ((step * train_batch_size) % (update_interval * 20) == 0 or \
                                               ((step * train_batch_size) % (
                                                       update_interval * 2) == 0 and tmp_acc > critical_acc)):
                ...
                if tmp_acc > best_acc:
                    ...
                    signal_break = signal_break + multiply
